...
-- ----------------------------
BEGIN;
INSERT INTO `dish` VALUES ('1', '2017/5/5', '西红柿超鸡蛋', 'i like it.', null, null, null, null);
COMMIT;
...
CREATE TABLE `users` (
  `user_id` int(25) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户编号',
...
-- ----------------------------
BEGIN;
INSERT INTO `users` VALUES ('1', 'sweet', '123', '\'\'', null), ('2', 'sweetshop', '123', '\'\'', '2017/5/5');
COMMIT;
